...
loadstring(game:HttpGet("https://pastebin.com/raw/30jUgCps"))() -- SkipCrashedGames program
    ...
    while scriptActive == true do wait()
        coroutine.wrap(function() -- PadAbuse
			if padAbuse == true then
				local pads = adminFlr.Pads:GetChildren("Head")
...
sendMsg("Shortcut v2, 2.3.3", game.Players.LocalPlayer.Name)
...
local function NKEI_fake_script() -- ScrollingFrame.LocalScript 
	...
	local bl = {"KTMY1", "1argeWeen", "Damix2131", "haroldjd2017ipad", "Siredx", "Antedx", "kickmeifyourmad", "Vxrgli", "RoyalMesh"} -- blacklist
	local LEDFRG = false
